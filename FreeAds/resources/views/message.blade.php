...
<div class="container">
    ...
    <div class="messagehead">
        <div class="pull-left">
            <h2 class="pull-left">CONTACT {{ strtoupper(getSellerName($seller_id)) }}</h2>
            ...
            <div class="ppost2">
                <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm-h-md-250 position-relative">
                    <div class="d-flex col p-4 d-flex flex-column position-static">
                        <div class="userinfo">
                            <div id="avatarnav">
                                <img class="avatarnav" src="{{ asset('images/avatars/' . getSellerAvatar($seller_id) ) }}"> 
                            </div>
                            <h6 id="usernameinfo">{{ getSellerName($seller_id) }}</h6>
                        </div>
                    </div>
                </div>
            </div>
