            ...
            <div class="searchsh">
                <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-2 shadow-sm-h-md-250 position-relative">
                     <div class="d-flex col p-3 d-flex flex-column position-static">
                        <form action="{{ route('real_estate') }}" method="GET">
                            <button type="submit" class="btnloc">FILTER BY LOCATION</button>
                                <div class="filter">
                                    ...
                                    @if(in_array($location->location_name, $checkedl)) checkedl @endif
                                    />
